...
#         print("请确保 config.sh 文件存在并包含以下配置:")
#         print("  FEATURE_DIR")
...
# final_path = os.path.join(output_dir, f"added_index.index")
