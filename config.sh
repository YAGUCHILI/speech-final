...
SPEAKER_ID=0                # 说话人ID
INDEX_RATE=0.75           # 索引检索强度0-1，越小越稳定越不像；越大越像越容易破音
DEVICE="cuda:0"             # 设备: cuda:0
IS_HALF=true                   #是否半精度推理
FILTER_RADIUS=5             #中值滤波半径，0保留原始细节，但可能有齿音；2-3推荐；5-7修复严重问题，但可能不太清晰
RMS_MIX_RATE=0.15           #RMS混合率，越小越像目标音色但表现力不够；越大越没有转换效果
PROTECT=0.5               #辅音保护程度：0.2-0.35轻度保护；越大保留越多原声辅音，转换可能不完全
